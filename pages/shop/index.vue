...
<template>
  <ul
    class="grid grid-cols-2 md:grid-cols-3 gap-4 bg-white rounded-xl p-4 w-full"
  >
    <li v-for="good in goods.data">
      <div
        class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
      >
        <nuxt-link :to="`/shop/goods/${good.attributes.slug}`">
          <nuxt-img
